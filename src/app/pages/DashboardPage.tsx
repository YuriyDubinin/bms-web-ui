...
export function DashboardPage() {
  return (
    <>
      <PageHeader title="Дашборд" subtitle="Ключевые показатели и активность за период" />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {KPIS.map((kpi) => (
          <Card key={kpi.label}>
            ...
            <p className="mt-3 font-mono text-2xl font-semibold tabular-nums tracking-tight sm:text-[28px]">
              {kpi.value}
            </p>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <Card className="flex flex-col lg:col-span-2">
          ...
          <p className="mt-2 text-sm leading-relaxed text-fg-secondary">
            Строгая, современная и удобная основа для серьёзного продукта. Единый набор токенов
            обеспечивает читаемую иерархию: <span className="text-fg-primary">основной</span>,
