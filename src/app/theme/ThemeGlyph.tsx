...
// Иконки времени суток (lucide-стиль): sunrise / sun / sunset / moon.
// currentColor — тонируются темой. Приватная карта путей, наружу — только компонент.
const PATHS: Record<ThemeId, ReactNode> = {
  morning: (
    <>
      <path d="M12 2v6" />
